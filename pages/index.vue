<template>
<div id="scrape"><body class="home page-template-default page page-id-1738 page-our-mission">
		<div id="page">

		<div id="accessibilitymenu" role="navigation">
			<div class="container">
				<ul>

					<li id="skip-to-content">Skip to Content</li>
		            
		            <li>
		            Text Size:
		            <span class="letter" data-letter="normal">A</span>
		            <span class="letter bigger" data-letter="bigger">A</span>
		            <span class="letter biggest" data-letter="biggest">A</span>
		            ...
		            <li>
		            Contrast:
		            <span class="contrast" data-contrast="normal">C</span>
		            <span class="contrast high" data-contrast="high">C</span>
...
<div class="frame">
		...
		<div id="upcoming">
		<h2 class="grey">Upcoming Events</h2>
		<div id="ucbbrand_component_events_rss-2" class="widget widget_ucbbrand_component_events_rss"><div class="block events">
...
<div id="homepagecontent" class="row">
	<div class="container">
		<div class="col-xs-12">
											<div class="ccblx">
	<div class="photext blx">			<div class="photext">
				...
				<h2>Our Mission</h2>
				<div class="photent">
<p>The Berkeley Food Institute strives to transform food systems to expand access to healthy, affordable food and promote sustainable and equitable food production. We empower new leaders with the capacity to cultivate diverse, just, resilient, and healthy food systems.</p>
</div>
    ...
    <div id="newsletter" class="row newsletter" style="background-image:linear-gradient(to top,rgba(25,119,169,0.7),rgba(25,119,169,0.7)),url(newsletterbg-2.jpg);">
        ...
        <div class="container">
                ...
                <div class="gf_browser_unknown gform_wrapper" id="gform_wrapper_5"><form method="post" enctype="multipart/form-data" target="gform_ajax_frame_5" id="gform_5" action="/">
                        <div class="gform_heading">
                            <h3 class="gform_title">Sign Up for Our Newsletter and Stay In Touch!</h3>
                        </div>
                        <div class="gform_body"><ul id="gform_fields_5" class="gform_fields top_label form_sublabel_below description_below"><div class="wrapone"><li id="field_5_1" class="gfield gfield_contains_required field_sublabel_below field_description_below gfield_visibility_visible"><label class="gfield_label" for="input_5_1">First Name<span class="gfield_required">*</span></label><div class="ginput_container ginput_container_text"><input name="input_1" id="input_5_1" type="text" value="" class="medium" placeholder="First Name" aria-required="true" aria-invalid="false"/></div></li><li id="field_5_4" class="gfield gfield_contains_required field_sublabel_below field_description_below gfield_visibility_visible"><label class="gfield_label" for="input_5_4">Last Name<span class="gfield_required">*</span></label><div class="ginput_container ginput_container_text"><input name="input_4" id="input_5_4" type="text" value="" class="medium" placeholder="Last Name" aria-required="true" aria-invalid="false"/></div></li><li id="field_5_2" class="gfield gfield_contains_required field_sublabel_below field_description_below gfield_visibility_visible"><label class="gfield_label" for="input_5_2">Email Address<span class="gfield_required">*</span></label><div class="ginput_container ginput_container_email">
                        ...
                        </div></li></div><li id="field_5_3" class="gfield field_sublabel_below field_description_below gfield_visibility_hidden"><label class="gfield_label">What would you like more info about? (check all that apply)</label><div class="ginput_container ginput_container_checkbox"><ul class="gfield_checkbox" id="input_5_3"><li class="gchoice_5_3_1">
								<input name="input_3.1" type="checkbox" value="BFI News &amp; Events" id="choice_5_3_1"/>
								<label for="choice_5_3_1" id="label_5_3_1">BFI News &amp; Events</label>
							</li><li class="gchoice_5_3_2">
								<input name="input_3.2" type="checkbox" value="Food &amp; Agriculture Policy Alerts" id="choice_5_3_2"/>
								<label for="choice_5_3_2" id="label_5_3_2">Food &amp; Agriculture Policy Alerts</label>
							</li><li class="gchoice_5_3_3">
								<input name="input_3.3" type="checkbox" value="Student Opportunities" id="choice_5_3_3"/>
								<label for="choice_5_3_3" id="label_5_3_3">Student Opportunities</label>
							</li><li class="gchoice_5_3_4">
								<input name="input_3.4" type="checkbox" value="UC Berkeley Foodscape Map" id="choice_5_3_4"/>
								<label for="choice_5_3_4" id="label_5_3_4">UC Berkeley Foodscape Map</label>
							</li></ul></div></li><div class="wraptwo"><li id="field_5_5" class="gfield field_sublabel_below field_description_below gfield_visibility_visible"><label class="gfield_label">BFI News &amp; Events</label><div class="ginput_container ginput_container_checkbox"><ul class="gfield_checkbox" id="input_5_5"><li class="gchoice_5_5_1">
								<input name="input_5.1" type="checkbox" value="BFI News &amp; Events" id="choice_5_5_1"/>
								<label for="choice_5_5_1" id="label_5_5_1">BFI News &amp; Events</label>
							</li></ul></div></li><li id="field_5_6" class="gfield field_sublabel_below field_description_below gfield_visibility_visible"><label class="gfield_label">Student Opportunities</label><div class="ginput_container ginput_container_checkbox"><ul class="gfield_checkbox" id="input_5_6"><li class="gchoice_5_6_1">
								<input name="input_6.1" type="checkbox" value="Student Opportunities" id="choice_5_6_1"/>
								<label for="choice_5_6_1" id="label_5_6_1">Student Opportunities</label>
							</li></ul></div></li><li id="field_5_7" class="gfield field_sublabel_below field_description_below gfield_visibility_visible"><label class="gfield_label">Food &amp; Agriculture Policy Alerts</label><div class="ginput_container ginput_container_checkbox"><ul class="gfield_checkbox" id="input_5_7"><li class="gchoice_5_7_1">
								<input name="input_7.1" type="checkbox" value="Food &amp; Agriculture Policy Alerts" id="choice_5_7_1"/>
								<label for="choice_5_7_1" id="label_5_7_1">Food &amp; Agriculture Policy Alerts</label>
        ...
        <div class="gform_footer top_label"> <input type="submit" id="gform_submit_button_5" class="gform_button button" value="Sign Up" onclick="if(window[&quot;gf_submitting_5&quot;]){return false;}  window[&quot;gf_submitting_5&quot;]=true;  " onkeypress="if( event.keyCode == 13 ){ if(window[&quot;gf_submitting_5&quot;]){return false;} window[&quot;gf_submitting_5&quot;]=true;  jQuery(&quot;#gform_5&quot;).trigger(&quot;submit&quot;,[true]); }"/><!-- Begin Daddy Analytics fields --><input type="hidden" name="" value=""/><input type="hidden" name="" value=""/><!-- End Daddy Analytics fields --> <input type="hidden" name="gform_ajax" value="form_id=5&amp;title=1&amp;description=&amp;tabindex=1"/>
            ...
            <input type="hidden" class="gform_hidden" name="state_5" value="WyJbXSIsIjA5ZDQ0MWMyMzI0YTRkODNlMTI3YTc1MTJlNzk2N2MxIl0="/>
    ...
    <div class="container topfooter">
        ...
        <td>
        <p>Berkeley Food Institute<br/>
University of California, Berkeley<br/>
23 Giannini Hall #3100<br/>
Berkeley, California, 94720-3100</p>
        <p><a href="mailto:foodinstitute@berkeley.edu">foodinstitute@berkeley.edu</a></p>        <p><a href="tel:510-643-8821">510-643-8821</a></p>        </td>
...
<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-8289"><a href="/search.html">d</a></li>
    ...
    <div class="container copyright">
		...
		<div class="newsmodal">
			<div class="formcont" data-interests="">
			<h4 id="thanks">Thank you for signing up! Help us to better serve your
interests by providing more information below:</h4>
			
                <div class="gf_browser_unknown gform_wrapper" id="gform_wrapper_13" style="display:none"><form method="post" enctype="multipart/form-data" target="gform_ajax_frame_13" id="gform_13" action="/">
                        <div class="gform_body"><ul id="gform_fields_13" class="gform_fields top_label form_sublabel_below description_below"><li id="field_13_1" class="gfield gform_hidden field_sublabel_below field_description_below gfield_visibility_visible"><input name="input_1" id="input_13_1" type="hidden" class="gform_hidden" aria-invalid="false" value=""/></li><li id="field_13_11" class="gfield gform_hidden field_sublabel_below field_description_below gfield_visibility_visible"><input name="input_11" id="input_13_11" type="hidden" class="gform_hidden" aria-invalid="false" value=""/></li><li id="field_13_9" class="gfield gform_hidden field_sublabel_below field_description_below gfield_visibility_visible"><input name="input_9" id="input_13_9" type="hidden" class="gform_hidden" aria-invalid="false" value=""/></li><li id="field_13_8" class="gfield field_sublabel_below field_description_below gfield_visibility_hidden"><label class="gfield_label">filter</label><div class="ginput_container ginput_container_checkbox"><ul class="gfield_checkbox" id="input_13_8"><li class="gchoice_13_8_1">
								<input name="input_8.1" type="checkbox" onclick="gf_apply_rules(13,[3,4,6,7]);" onkeypress="gf_apply_rules(13,[3,4,6,7]);" value="news" id="choice_13_8_1"/>
								<label for="choice_13_8_1" id="label_13_8_1">news</label>
							</li><li class="gchoice_13_8_2">
								<input name="input_8.2" type="checkbox" onclick="gf_apply_rules(13,[3,4,6,7]);" onkeypress="gf_apply_rules(13,[3,4,6,7]);" value="student" id="choice_13_8_2"/>
								<label for="choice_13_8_2" id="label_13_8_2">student</label>
							</li><li class="gchoice_13_8_3">
								<input name="input_8.3" type="checkbox" onclick="gf_apply_rules(13,[3,4,6,7]);" onkeypress="gf_apply_rules(13,[3,4,6,7]);" value="policy" id="choice_13_8_3"/>
								<label for="choice_13_8_3" id="label_13_8_3">policy</label>
							</li><li class="gchoice_13_8_4">
								<input name="input_8.4" type="checkbox" onclick="gf_apply_rules(13,[3,4,6,7]);" onkeypress="gf_apply_rules(13,[3,4,6,7]);" value="foodscape" id="choice_13_8_4"/>
								<label for="choice_13_8_4" id="label_13_8_4">foodscape</label>
							</li></ul></div></li><li id="field_13_3" class="gfield field_sublabel_below field_description_below gfield_visibility_visible"><label class="gfield_label" for="input_13_3">Are you currently a student?</label><div class="ginput_container ginput_container_select"><select name="input_3" id="input_13_3" class="medium gfield_select" aria-invalid="false"><option value="UC Berkeley Undergraduate">UC Berkeley Undergraduate</option><option value="UC Berkeley Masters Student">UC Berkeley Masters Student</option><option value="UC Berkeley Doctoral Student">UC Berkeley Doctoral Student</option><option value="UC Berkeley Alum">UC Berkeley Alum</option><option value="Non-UC Berkeley Undergraduate">Non-UC Berkeley Undergraduate</option><option value="Non-UC Berkeley Masters Student">Non-UC Berkeley Masters Student</option><option value="Non-UC Berkeley Doctoral Student">Non-UC Berkeley Doctoral Student</option><option value="High School Student">High School Student</option><option value="Other Student">Other Student</option><option value="Not a Student">Not a Student</option></select></div></li><li id="field_13_4" class="gfield field_sublabel_below field_description_below gfield_visibility_visible"><label class="gfield_label" for="input_13_4">If not a student, what is your field?</label><div class="ginput_container ginput_container_select"><select name="input_4" id="input_13_4" class="medium gfield_select" aria-invalid="false"><option value="Agriculture">Agriculture</option><option value="Consultant">Consultant</option><option value="Creative Industries">Creative Industries</option><option value="Education/University">Education/University</option><option value="Food Retail and Restaurants">Food Retail and Restaurants</option><option value="Financial Services">Financial Services</option><option value="Government">Government</option><option value="Health Care">Health Care</option><option value="Manufacturing">Manufacturing</option><option value="Media">Media</option><option value="Nonprofit">Nonprofit</option><option value="Philanthropy">Philanthropy</option><option value="Technology">Technology</option><option value="Unemployed">Unemployed</option><option value="Other">Other</option></select></div></li><li id="field_13_5" class="gfield field_sublabel_below field_description_below gfield_visibility_visible"><label class="gfield_label" for="input_13_5">Affiliation / Employer</label><div class="ginput_container ginput_container_text"><input name="input_5" id="input_13_5" type="text" value="UC Berkeley (Student)" class="medium" aria-invalid="false"/></div></li><li id="field_13_6" class="gfield field_sublabel_below field_description_below gfield_visibility_visible"><label class="gfield_label" for="input_13_6">Title</label><div class="ginput_container ginput_container_text"><input name="input_6" id="input_13_6" type="text" value="" class="medium" aria-invalid="false"/></div></li><li id="field_13_2" class="gfield field_sublabel_below field_description_below gfield_visibility_visible"><label class="gfield_label" for="input_13_2">Zip</label><div class="ginput_container ginput_container_number"><input name="input_2" id="input_13_2" type="text" value="" class="medium" aria-invalid="false"/></div></li><li id="field_13_7" class="gfield field_sublabel_below field_description_below gfield_visibility_visible"><label class="gfield_label" for="input_13_7">What are your policy interests?</label><div class="ginput_container ginput_container_textarea"><textarea name="input_7" id="input_13_7" class="textarea medium" aria-invalid="false" rows="10" cols="50"/></div></li>
                            </ul></div>
        <div class="gform_footer top_label"> <input type="submit" id="gform_submit_button_13" class="gform_button button" value="Submit" onclick="if(window[&quot;gf_submitting_13&quot;]){return false;}  window[&quot;gf_submitting_13&quot;]=true;  " onkeypress="if( event.keyCode == 13 ){ if(window[&quot;gf_submitting_13&quot;]){return false;} window[&quot;gf_submitting_13&quot;]=true;  jQuery(&quot;#gform_13&quot;).trigger(&quot;submit&quot;,[true]); }"/><!-- Begin Daddy Analytics fields --><input type="hidden" name="" value=""/><input type="hidden" name="" value=""/><!-- End Daddy Analytics fields --> <input type="hidden" name="gform_ajax" value="form_id=13&amp;title=&amp;description=&amp;tabindex=1"/>
            <input type="hidden" class="gform_hidden" name="is_submit_13" value="1"/>
            <input type="hidden" class="gform_hidden" name="gform_submit" value="13"/>
            
            <input type="hidden" class="gform_hidden" name="gform_unique_id" value=""/>
            <input type="hidden" class="gform_hidden" name="state_13" value="WyJbXSIsIjA5ZDQ0MWMyMzI0YTRkODNlMTI3YTc1MTJlNzk2N2MxIl0="/>
